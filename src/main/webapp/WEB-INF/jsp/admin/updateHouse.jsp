...
<div class="wrap">
		...
		<div id="content">
			<form action="updatePageHouse" method="post">
				<div class="pos"><h3>修改房间</h3></div>
				<div class="conleft">
					<div id="conliangcon">
						<!-- <h3 id="comentit">房间编号</h3> -->
						<input type="hidden" class="comenbox" name="hpid" value="${hotelPrice.hpid} ">
					</div>
					<div id="conliangcon">
						<h3 id="comentit">房间价格</h3>
						<input type="text" name="price" class="comenbox" value="${hotelPrice.price} ">
					</div>
					<div id="conliangcon">
						<h3 id="comentit">房间面积</h3>
						<input class="comenbox" name="area" value="${hotelPrice.area }"></input>
					</div>
					<div id="conliangcon">
						<h3 id="comentit">房间楼层</h3>
						<input class="comenbox" name="floor" value="${hotelPrice.floor }"></input>
					</div>
					<div id="conliangcon">
						<h3 id="comentit">是否无烟</h3>
						<input class="comenbox" name="smoke" value="${hotelPrice.smoke }"></input>
					</div>
					
					<div id="conliangcon">
						<h3 id="comentit">最大人数</h3>
						<input class="comenbox" name="peomax" value="${hotelPrice.peomax}"></input>
					</div>
