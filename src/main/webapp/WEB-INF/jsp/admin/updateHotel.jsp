...
<div class="wrap">
		...
		<div id="content">
			<p id="update">修改酒店信息:</p>
			<hr/>
			<form id="updateHotel" action="updateHotel" method="post">
				<input type="hidden" name="hid" value="${hotel.hid }"/><br/>
				酒店名称:<input class="message" type="text" name="name" value="${hotel.name }"/><br/>
				联系方式:<input class="message" type="text" name="contact" value="${hotel.contact }"/><br/>
				酒店地址:<input class="message" type="text" name="address" value="${hotel.address }"/><br/>
				酒店特色:<input class="message" type="text" name="feature" value="${hotel.feature }"/><br/>
				酒店星级:<input class="message" type="text" name="level" value="${hotel.level }"/><br/>
				酒店服务:<input class="message" type="text" name="serverDesc" value="${hotel.serverDesc }"/><br/>
				服务时间:<input class="message" type="text" name="intime" value="${hotel.intime }"/><br/>
				服务结束:<input class="message" type="text" name="outtime" value="${hotel.outtime }"/><br/>
