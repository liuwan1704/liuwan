...
<link rel="stylesheet" href="./css/addHotelPic.css">
<title>添加酒店图片</title>
</head>
<body>
<div class="wrap">
		...
		<div id="content">
		<hr/>
			<form id="addHotelPic" action="addHotelPic?hid=${hid }" method="post" enctype="multipart/form-data">
				请选择酒店图片:<input id="picFile" type="file" name="file"/>
